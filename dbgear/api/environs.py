...
def get_table(id: str, instance: str, table: str, segment: str | None, request: Request):
    proj = project(request)
...
def update_data(id: str, instance: str, table: str, segment: str | None, request: Request, body=Body(...)):
    proj = project(request)
    map = mapping.get(proj.folder, id)
...
def import_data(id: str, instance: str, table: str, segment: str | None, imp: ImportSQL, request: Request):
    proj = project(request)
    map = mapping.get(proj.folder, id)
